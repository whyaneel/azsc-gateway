var GET_USERS = '/api/admin/users';
var GET_USER_BY_ID = '/api/admin/users/{id}';
var DELETE_USER_BY_ID = '/api/admin/users/{id}';
var GET_USERS_INACTIVE = '/api/admin/inactive/users';
var GET_USER_BY_ID_INACTIVE = '/api/admin/inactive/users/{id}';
var DELETE_USER_BY_ID_INACTIVE = '/api/admin/inactive/users/{id}';
active = true;
